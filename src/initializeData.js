...
export default dispatch => {
  ...
  dispatch(
    addFurnitureType(
      ...
      "Eric",
      59.95,
      [url + "/img/eric1.jpg", url + "/img/eric2.jpg"],
  ...
  dispatch(
    addFurnitureType(
      ...
      "Arendtsville",
      63.95,
      [url + "/img/arendtsville1.jpg", url + "/img/arendtsville2.jpg"],
  ...
  dispatch(
    addFurnitureType(
      ...
      "Tally Ho",
      49.95,
      [url + "/img/tallyho1.jpg", url + "/img/tallyho2.jpg"],
  ...
  dispatch(
    addFurnitureType(
      ...
      "Melmore",
      59.95,
      [url + "/img/melmore1.jpg", url + "/img/melmore2.jpg"],
  ...
  dispatch(
    addFurnitureType(
      ...
      "Ahart",
      99.95,
      [url + "/img/ahart1.jpg", url + "/img/ahart2.jpg"],
  ...
  dispatch(
    addFurnitureType(
      ...
      "Cainsville",
      87.95,
      [url + "/img/cainsville1.jpg", url + "/img/cainsville2.jpg"],
  ...
  dispatch(
    addFurnitureType(
      ...
      "Akbar",
      76.95,
      [url + "/img/akbar1.jpg", url + "/img/akbar2.jpg"],
  ...
  dispatch(
    addFurnitureType(
      ...
      "Kenton",
      79.95,
      [url + "/img/kenton1.jpg", url + "/img/kenton2.jpg"],
  ...
  dispatch(
    addFurnitureType(
      ...
      "Labarge",
      94.95,
      [url + "/img/labarge1.jpg", url + "/img/labarge2.jpg"],
  ...
  dispatch(
    addFurnitureType(
      ...
      "Lamantica",
      129.95,
      [url + "/img/lamantica1.jpg", url + "/img/lamantica2.jpg"],
  ...
  dispatch(
    addFurnitureType(
      ...
      "Walworth",
      139.95,
      [url + "/img/walworth1.jpg", url + "/img/walworth2.jpg"],
  ...
  dispatch(
    addFurnitureType(
      ...
      "Crenshaw",
      144.95,
      [url + "/img/crenshaw1.jpg", url + "/img/crenshaw2.jpg"],
  ...
  dispatch(
    addFurnitureType(
      ...
      "Borchert",
      109.95,
      [url + "/img/borchert1.jpg", url + "/img/borchert2.jpg"],
  ...
  dispatch(
    addFurnitureType(
      ...
      "Jo Etagere",
      124.95,
      [url + "/img/joEtagere1.jpg", url + "/img/joEtagere2.jpg"],
